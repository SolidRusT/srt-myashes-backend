...
# MyAshes.ai Local Development Initialization Script
...
sed -i "s/BACKEND_CORS_ORIGINS=.*/BACKEND_CORS_ORIGINS=[\"http://localhost\", \"http://localhost:3000\", \"http://localhost:8000\"]/" docker/.env
print_success "Set CORS settings for local development."
